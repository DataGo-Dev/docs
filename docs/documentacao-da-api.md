---
id: documentacao-da-api
title: Documentação da API
sidebar_position: 1
---

Documentação oficial para uso da API do Nitzap.

| # | Tópico | Descrição |
| --- | --- | --- |
| 1 | [Postman Collection e Configuração](./postman-collection-e-configuracao.md) | Importar e configurar a Collection do Postman |
| 2 | [Conexão com Nitzap](./conexao-com-nitzap.md) | Conectar seu WhatsApp via QR Code ou Pair Code |
